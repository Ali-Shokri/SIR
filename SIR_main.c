...
// hello everyone :). this is my Msc. thesis code. I used it to study numebrical investigation of quasi-one
// systems with the emphasize on induced resonance for fermionic particles. I deployed a grid method to 
// investigate the quantum scattering for two particles in two separated constraints with tranverse
// harmonic potential well in low energy limit.
...
int main()
{
    ...
    /*-----------inputs----------*/
	E=2.0e-5;     // the energy of the system
	which='P';
  	V0 = 0.9215;  // the minimum of the potential 
	max=0.923;    // the maximum of the potential 
	Dif=0.0005;   // the steps of the potential
	/* defining the dimensions griding numbers, n for griding the R, n_t for griding for Teta
	, the angle between the vector and Z axis and n_phi, griding for Phi, the angle between the
	image of the vector and X axis*/
	n=50000;
	n_t=30;
	n_phi=9;
	rm=150.0;
	d_on_a_0=0.1;  // the separation between two potential well
	/*----------End of inputs------------*/
